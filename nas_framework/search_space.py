...
class NASSearchSpace:
    ...
    def __init__(self, num_blocks_per_cell: int = 5):
        ...
        # Sources in a cell output-concatenation context: ck-1, ck-2, block_0..block_(B-1)
    ...
    def random_individual(self) -> list[int]:
        # Compatibility with existing Population.initialize() API.
    ...
    def num_possible_architectures(self) -> int:
        # Paper-level approximation used by Dvolver (~1e20).
        return int(1e20)
